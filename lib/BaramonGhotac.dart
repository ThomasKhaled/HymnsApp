...
class BaramonGhotac extends StatefulWidget{
  ...
  BaramonGhotac(this.title);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return BaramonGhotacState(title);
  }
}

class BaramonGhotacState extends State<BaramonGhotac>{
  String title;
  var url,urlasync;
  ...
  Future<String> getAudioUrl(text) async{
    final fb.StorageReference storage = fb.app().storage().refFromURL("gs://movieapp-216811.appspot.com/");
    var ref = storage.child(getAudioName(text));
